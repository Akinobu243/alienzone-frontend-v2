if (!self.define) {
  ...
  self.define = (a, c) => {
    ...
    s[n] = Promise.all(a.map((e) => f[e] || t(e))).then((e) => (c(...e), r))
  }
}
      ...
      [
        {
          ...
          revision: "86a22e1d64c4e053c2f075c114d00bfe",
        },
        {
          url: "/_next/static/chunks/0e5ce63c-ba908e60fa75493d.js",
          revision: "mLfPPr7TYweqJcRyseGi2",
        },
        {
        ...
        {
          url: "/_next/static/mLfPPr7TYweqJcRyseGi2/_buildManifest.js",
          revision: "172e769da91baa11de9b258fb2d92f86",
        },
        {
          url: "/_next/static/mLfPPr7TYweqJcRyseGi2/_ssgManifest.js",
